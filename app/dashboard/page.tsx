...
export default function Dashboard() {
  ...
  if (authLoading || loading) return <div className="flex h-64 items-center justify-center"><Loader2 className="animate-spin text-brand-500" /></div>;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      {collections.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {collections.map(col => (
            <Card key={col.id} onClick={() => router.push(`/edit/${col.id}`)} className="group h-64 flex flex-col relative transition-all hover:ring-2 hover:ring-brand-500/20">
